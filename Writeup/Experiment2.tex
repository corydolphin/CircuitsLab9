...
In this experiment, we found the limiting values of $I_{out}$ to be $+ 66.69 \mu A$, and $-70.01 \mu A$, fairly symmetric on both rails. 
 % Also, record the limiting values of I out in both the positive and the negative directions. In your report, include a plot showing Iout versus Vdm along with the best-ﬁt line.
